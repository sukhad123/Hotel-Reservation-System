...
public class PentHouse extends Room {
    ...
    private final SimpleStringProperty name = new SimpleStringProperty("PentHouse");
    private SimpleDoubleProperty rate = new SimpleDoubleProperty(2000);

    // Constructor remains unchanged
    public PentHouse(int roomId) {
